...
public func _bjs_testStringDefault(_ messageBytes: Int32, _ messageLength: Int32) -> Void {
    ...
    let ret = testStringDefault(message: message)
    return ret.bridgeJSLowerReturn()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_testNegativeIntDefault(_ value: Int32) -> Int32 {
    ...
    let ret = testNegativeIntDefault(value: value)
    return ret.bridgeJSLowerReturn()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_testBoolDefault(_ flag: Int32) -> Int32 {
    ...
    let ret = testBoolDefault(flag: flag)
    return ret.bridgeJSLowerReturn()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_testNegativeFloatDefault(_ temp: Float32) -> Float32 {
    #if arch(wasm32)
    let temp = Float.bridgeJSLiftParameter(temp)
    let ret = testNegativeFloatDefault(temp: temp)
    return ret.bridgeJSLowerReturn()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_testDoubleDefault(_ precision: Float64) -> Float64 {
    #if arch(wasm32)
    let precision = Double.bridgeJSLiftParameter(precision)
    let ret = testDoubleDefault(precision: precision)
    return ret.bridgeJSLowerReturn()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_testOptionalDefault(_ nameIsSome: Int32, _ nameBytes: Int32, _ nameLength: Int32) -> Void {
    ...
    let ret = testOptionalDefault(name: name)
    return ret.bridgeJSLowerReturn()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_testOptionalStringDefault(_ greetingIsSome: Int32, _ greetingBytes: Int32, _ greetingLength: Int32) -> Void {
    #if arch(wasm32)
    let greeting = Optional<String>.bridgeJSLiftParameter(greetingIsSome, greetingBytes, greetingLength)
    let ret = testOptionalStringDefault(greeting: greeting)
    return ret.bridgeJSLowerReturn()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_testMultipleDefaults(_ titleBytes: Int32, _ titleLength: Int32, _ count: Int32, _ enabled: Int32) -> Void {
    ...
    let ret = testMultipleDefaults(title: title, count: count, enabled: enabled)
    return ret.bridgeJSLowerReturn()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_testEnumDefault(_ status: Int32) -> Int32 {
    ...
    let ret = testEnumDefault(status: status)
    return ret.bridgeJSLowerReturn()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_testComplexInit(_ greeter: UnsafeMutableRawPointer) -> UnsafeMutableRawPointer {
    #if arch(wasm32)
    let greeter = DefaultGreeter.bridgeJSLiftParameter(greeter)
    let ret = testComplexInit(greeter: greeter)
    return ret.bridgeJSLowerReturn()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_testEmptyInit(_ greeter: UnsafeMutableRawPointer) -> UnsafeMutableRawPointer {
    #if arch(wasm32)
    let greeter = EmptyGreeter.bridgeJSLiftParameter(greeter)
    let ret = testEmptyInit(greeter: greeter)
    return ret.bridgeJSLowerReturn()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_testOptionalStructDefault() -> Void {
    #if arch(wasm32)
    let point = Optional<Config>.bridgeJSLiftParameter()
    let ret = testOptionalStructDefault(point: point)
    return ret.bridgeJSLowerReturn()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_testOptionalStructWithValueDefault() -> Void {
    #if arch(wasm32)
    let point = Optional<Config>.bridgeJSLiftParameter()
    let ret = testOptionalStructWithValueDefault(point: point)
    return ret.bridgeJSLowerReturn()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_testIntArrayDefault() -> Void {
    ...
    let ret = testIntArrayDefault(values: values)
...
public func _bjs_testStringArrayDefault() -> Void {
    #if arch(wasm32)
    let names = [String].bridgeJSStackPop()
    let ret = testStringArrayDefault(names: names)
    ret.bridgeJSStackPush()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_testDoubleArrayDefault() -> Void {
    ...
    let ret = testDoubleArrayDefault(values: values)
    ret.bridgeJSStackPush()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_testBoolArrayDefault() -> Void {
    ...
    let ret = testBoolArrayDefault(flags: flags)
    ret.bridgeJSStackPush()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_testEmptyArrayDefault() -> Void {
    #if arch(wasm32)
    let items = [Int].bridgeJSStackPop()
    let ret = testEmptyArrayDefault(items: items)
    ret.bridgeJSStackPush()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_testMixedWithArrayDefault(_ nameBytes: Int32, _ nameLength: Int32, _ enabled: Int32) -> Void {
    ...
    let ret = testMixedWithArrayDefault(name: name, values: values, enabled: enabled)
    return ret.bridgeJSLowerReturn()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_DefaultGreeter_init(_ nameBytes: Int32, _ nameLength: Int32) -> UnsafeMutableRawPointer {
    #if arch(wasm32)
    let name = String.bridgeJSLiftParameter(nameBytes, nameLength)
    let ret = DefaultGreeter(name: name)
    return ret.bridgeJSLowerReturn()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_DefaultGreeter_name_get(_ _self: UnsafeMutableRawPointer) -> Void {
    #if arch(wasm32)
    let _self = DefaultGreeter.bridgeJSLiftParameter(_self)
    let ret = _self.name
    return ret.bridgeJSLowerReturn()
    #else
    fatalError("Only available on WebAssembly")
...
public func _bjs_ConstructorDefaults_init(_ nameBytes: Int32, _ nameLength: Int32, _ count: Int32, _ enabled: Int32, _ status: Int32, _ tagIsSome: Int32, _ tagBytes: Int32, _ tagLength: Int32) -> UnsafeMutableRawPointer {
    ...
    let count = Int.bridgeJSLiftParameter(count)
    let name = String.bridgeJSLiftParameter(nameBytes, nameLength)
    let ret = ConstructorDefaults(name: name, count: count, enabled: enabled, status: status, tag: tag)
    return ret.bridgeJSLowerReturn()
    #else
    fatalError("Only available on WebAssembly")
    #endif
...
public func _bjs_ConstructorDefaults_name_get(_ _self: UnsafeMutableRawPointer) -> Void {
    #if arch(wasm32)
    let _self = ConstructorDefaults.bridgeJSLiftParameter(_self)
    let ret = _self.name
    return ret.bridgeJSLowerReturn()
    #else
    fatalError("Only available on WebAssembly")
