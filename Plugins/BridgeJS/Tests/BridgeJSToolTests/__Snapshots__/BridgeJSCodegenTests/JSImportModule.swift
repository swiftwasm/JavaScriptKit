...
#if arch(wasm32)
@_extern(wasm, module: "TestModule", name: "bjs_ImportedModuleCounter_init")
...
#if arch(wasm32)
@_extern(wasm, module: "TestModule", name: "bjs_ImportedModuleCounter_create_static")
...
#if arch(wasm32)
@_extern(wasm, module: "TestModule", name: "bjs_ImportedModuleCounter_value_get")
...
#if arch(wasm32)
@_extern(wasm, module: "TestModule", name: "bjs_ImportedModuleCounter_value_set")
...
#if arch(wasm32)
@_extern(wasm, module: "TestModule", name: "bjs_ImportedModuleCounter_increment")
