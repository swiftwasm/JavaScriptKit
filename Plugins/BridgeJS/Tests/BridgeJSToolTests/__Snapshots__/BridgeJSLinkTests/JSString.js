...
export async function createInstantiator(options, swift) {
    ...
    return {
        ...
        addImports: (importObject, importsContext) => {
            ...
            TestModule["bjs_jsCheckJSString"] = function bjs_jsCheckJSString(a) {
                try {
                    imports.jsCheckJSString(swift.memory.getObject(a));
                } catch (error) {
                    setException(error);
                }
            }
            TestModule["bjs_jsGetJSString"] = function bjs_jsGetJSString() {
                try {
                    let ret = imports.jsGetJSString();
        ...
        createExports: (instance) => {
            ...
            const exports = {
                checkJSString: function bjs_checkJSString(a) {
                    instance.exports.bjs_checkJSString(swift.memory.retain(a));
                },
                getJSString: function bjs_getJSString() {
                    const ret = instance.exports.bjs_getJSString();
                    const ret1 = swift.memory.getObject(ret);
                    swift.memory.release(ret);
                    return ret1;
                },
                roundTripJSString: function bjs_roundTripJSString(value) {
                    const ret = instance.exports.bjs_roundTripJSString(swift.memory.retain(value));
                    const ret1 = swift.memory.getObject(ret);
                    swift.memory.release(ret);
                    return ret1;
                },
