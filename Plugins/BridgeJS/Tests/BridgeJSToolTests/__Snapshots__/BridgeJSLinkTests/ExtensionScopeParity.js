...
export async function createInstantiator(options, swift) {
    ...
    let _exports = null;
    let bjs = null;
    const __bjs_createStructHelpers_M10TestModuleT6SignalT4Meta = () => ({
        lower: (value) => {
            const bytes = textEncoder.encode(value.note);
    ...
    return {
        ...
        addImports: (importObject, importsContext) => {
            ...
            bjs["swift_js_struct_lower_Meta"] = function(objectId) {
                structHelpers.M10TestModuleT6SignalT4Meta.lower(swift.memory.getObject(objectId));
            }
            bjs["swift_js_struct_lift_Meta"] = function() {
                const value = structHelpers.M10TestModuleT6SignalT4Meta.lift();
            ...
            importObject["TestModule"]["bjs_app_Toolbox_Hammer_wrap"] = function(pointer) {
                const obj = _exports.app.Toolbox.Hammer.__construct(pointer);
                return swift.memory.retain(obj);
            };
            importObject["TestModule"]["bjs_app_Toolbox_Mallet_wrap"] = function(pointer) {
                const obj = _exports.app.Toolbox.Mallet.__construct(pointer);
                return swift.memory.retain(obj);
            };
        },
        setInstance: (i) => {
        ...
        createExports: (instance) => {
            ...
            class Mallet extends SwiftHeapObject {
                static __construct(ptr) {
                    return SwiftHeapObject.__wrap(ptr, instance.exports.bjs_app_Toolbox_Mallet_deinit, Mallet.prototype, null);
                }

                constructor() {
                    const ret = instance.exports.bjs_app_Toolbox_Mallet_init();
                    return Mallet.__construct(ret);
                }
            }
            class Hammer extends SwiftHeapObject {
                static __construct(ptr) {
                    return SwiftHeapObject.__wrap(ptr, instance.exports.bjs_app_Toolbox_Hammer_deinit, Hammer.prototype, null);
                }

                constructor() {
                    const ret = instance.exports.bjs_app_Toolbox_Hammer_init();
                    return Hammer.__construct(ret);
                }
            }
            const __bjs_helpers_M10TestModuleT6SignalT4Meta = __bjs_createStructHelpers_M10TestModuleT6SignalT4Meta();
            structHelpers.M10TestModuleT6SignalT4Meta = __bjs_helpers_M10TestModuleT6SignalT4Meta;

            const exports = {
                Signal: SignalValues,
                Meta: {
                    init: function(note) {
                        const noteBytes = textEncoder.encode(note);
                        const noteId = swift.memory.retain(noteBytes);
                        instance.exports.bjs_Meta_init(noteId, noteBytes.length);
                        const structValue = structHelpers.M10TestModuleT6SignalT4Meta.lift();
                        return structValue;
                    },
                },
                app: {
