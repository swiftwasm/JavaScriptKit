...
export async function createInstantiator(options, swift) {
    ...
    return {
        ...
        createExports: (instance) => {
            ...
            if (typeof globalThis.GlobalAPI === 'undefined') {
                globalThis.GlobalAPI = {};
            }
            const exports = {
                GlobalAPI: {
                    GlobalClass,
            ...
            _exports = exports;
            globalThis.GlobalAPI.GlobalClass = exports.GlobalAPI.GlobalClass;
            globalThis.GlobalAPI.globalFunction = exports.GlobalAPI.globalFunction;
            return exports;
        },
    }
}