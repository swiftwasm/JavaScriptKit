...
export async function createInstantiator(options, swift) {
    ...
    return {
        ...
        addImports: (importObject, importsContext) => {
            ...
            TestModule["bjs_StaticBox_value"] = function bjs_StaticBox_value(self) {
                try {
            ...
            TestModule["bjs_WithCtor_init"] = function bjs_WithCtor_init(value) {
                try {
                    return swift.memory.retain(new imports.WithCtor(value));
                } catch (error) {
                    setException(error);
                    return 0
                }
            }
            TestModule["bjs_WithCtor_create_static"] = function bjs_WithCtor_create_static(value) {
                try {
                    let ret = imports.WithCtor.create(value);
                    return swift.memory.retain(ret);
                } catch (error) {
                    setException(error);
                    return 0
